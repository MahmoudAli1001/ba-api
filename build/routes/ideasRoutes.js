...
router.post("/", auth_1.authenticate, (0, auth_1.authorize)(["admin"]), uploadFile_1.upload.single("image"), (0, validate_1.validate)(ideaClubValidator_1.createIdeaClubSchema), ideaClubController_1.default.createIdeaClub);
...
router.patch("/:id", auth_1.authenticate, (0, auth_1.authorize)(["admin"]), uploadFile_1.upload.single("image"), (0, validate_1.validate)(ideaClubValidator_1.updateIdeaClubSchema), ideaClubController_1.default.updateIdeaClub);
